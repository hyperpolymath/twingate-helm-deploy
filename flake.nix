{
  description = "twingate-helm-deploy - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 twingate-helm-deploy development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P twingate-helm-deploy.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/twingate-helm-deploy $out/bin/  # Rust
            # cp bin/twingate-helm-deploy $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/twingate-helm-deploy";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-twingate-helm-deploy" {
